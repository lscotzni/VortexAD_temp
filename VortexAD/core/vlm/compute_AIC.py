...
def compute_AIC(num_nodes, mesh_dict, eval_pt_name):
    ...
    for i in range(num_surfaces):
        ...
        eval_pt_i = mesh_dict[surface_name][eval_pt_name] # (num_nodes, ns-1, nc-1, 3)
        ...
        for j in range(num_surfaces):
            ...
            eval_pt_i_exp = csdl.Variable(shape=(num_nodes, np_surf_j, nc_i-1, ns_i-1, 3), value=0.)
            ...
            eval_pt_i_wake_exp = csdl.Variable(shape=(num_nodes, np_wake_j, nc_i-1, ns_i-1, 3), value=0.)
