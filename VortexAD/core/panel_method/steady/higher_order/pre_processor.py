...
def pre_processor(mesh_dict, mode='structured'):
    ...
    if mode == 'structured':
        ...
        # edge_normal_vec = csdl.Variable(value=np.zeros(edge_vec.shape))
        # edge_normal_vec = edge_normal_vec.set(csdl.slice[:,:,0,:], value=csdl.cross(edge_vec[:,:,0,:], normal_vec, axis=2))
        # edge_normal_vec = edge_normal_vec.set(csdl.slice[:,:,1,:], value=csdl.cross(edge_vec[:,:,1,:], normal_vec, axis=2))
        # edge_normal_vec = edge_normal_vec.set(csdl.slice[:,:,2,:], value=csdl.cross(edge_vec[:,:,2,:], normal_vec, axis=2))
