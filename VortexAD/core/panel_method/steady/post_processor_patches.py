...
def post_processor_patches(mesh_dict, mu, sigma, num_nodes):
    ...
    for i in range(len(surface_names)):
        ...
        for j, patch_name in enumerate(patch_names):
            ...
            num_panels = mesh_dict[surface_name][patch_name]['num_panels']
            nc, ns = mesh_dict[surface_name][patch_name]['nc'], mesh_dict[surface_name][patch_name]['ns']
            stop += num_panels

            panel_areas = mesh_dict[surface_name][patch_name]['panel_area']
            ...
            delta_coll_point = mesh_dict[surface_name][patch_name]['delta_coll_point']
            ql, qm = least_squares_velocity(mu_grid, delta_coll_point)
            # endregion

            panel_x_dir = mesh_dict[surface_name][patch_name]['panel_x_dir']
            panel_y_dir = mesh_dict[surface_name][patch_name]['panel_y_dir']
            panel_normal = mesh_dict[surface_name][patch_name]['panel_normal']
            nodal_cp_velocity = mesh_dict[surface_name][patch_name]['nodal_cp_velocity']
            coll_vel = mesh_dict[surface_name][patch_name]['coll_point_velocity']
            if coll_vel:
            ...
            rot_mat = mesh_dict[surface_name][patch_name]['rot_mat']
            ...
            panel_area = mesh_dict[surface_name][patch_name]['panel_area']
            ...
            planform_area = mesh_dict[surface_name][patch_name]['planform_area']
            ...
            patch_dict['CL'] = CL
            patch_dict['CDi'] = CDi
            patch_dict['Fx_panel'] = Fx_panel
            patch_dict['Fz_panel'] = Fz_panel
            patch_dict['panel_forces'] = dF
            
            patch_dict['body_vel'] = body_vel_norm

            patch_dict['panel_pressure'] = dP
            patch_dict['surface_vel'] = body_vel_global

            surf_dict[patch_name] = patch_dict
